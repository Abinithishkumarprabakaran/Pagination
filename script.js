...
btn_next.addEventListener('click', ()=>{
    ...
    // statically changing the for attribute value and the innertext!
    // we should keep anyone of the attribute as static. so we are using for attribute

    // var taking_for = document.querySelector('.btn-1');
    ...
    //dynamically using for loop

    //we can use template literal
